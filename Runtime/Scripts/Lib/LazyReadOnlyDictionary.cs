...
namespace LazyUI
{
    public struct LazyReadOnlyDictionary<TKey, TValue> : ICollection<KeyValuePair<TKey, TValue>>, IEnumerable<KeyValuePair<TKey, TValue>>, IEnumerable, IDictionary<TKey, TValue>, IReadOnlyCollection<KeyValuePair<TKey, TValue>>, IReadOnlyDictionary<TKey, TValue>, ICollection, IDictionary
    {
        private readonly Dictionary<TKey, TValue> dict;
        public LazyReadOnlyDictionary(Dictionary<TKey, TValue> dict)
        {
            this.dict = dict;
        }
        public static implicit operator LazyReadOnlyDictionary<TKey, TValue>(Dictionary<TKey, TValue> dict)
        {
            return new LazyReadOnlyDictionary<TKey, TValue>(dict);
        }
